...
{ 
    ...
    public class StoryReplyActivity : AppCompatActivity, DragToClose.IDragListener 
    {
        ...
        private string StoryId, UserId; // to_id  
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (Methods.CheckConnectivity())
                    {
                        ...
                        {
                            SendMess(replacement).ConfigureAwait(false);
                        });
                    }
                    else
                    {
        ...
        public async Task SendMess(string replacement)
        {
            try
            {
                if (!Methods.CheckConnectivity())
                ...
                else
                {
                    ...
                    var (apiStatus, respond) = await RequestsAsync.Message.SendMessageAsync(UserId, time2, replacement, "", "", "", "", "", "", "", "", StoryId);
                    if (apiStatus == 200)
                    {
