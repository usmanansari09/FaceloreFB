...
namespace WoWonder.Library.Anjo.Stories
{
    ...
    {
        private static float MinScaleDepth = 0.75f;
        private static float MinScaleZoom = 0.85f;
        private static float MinAlphaZoom = 0.5f;
        private static float ScaleFactorSlide = 0.85f;
        private static float MinAlphaSlide = 0.35f;
