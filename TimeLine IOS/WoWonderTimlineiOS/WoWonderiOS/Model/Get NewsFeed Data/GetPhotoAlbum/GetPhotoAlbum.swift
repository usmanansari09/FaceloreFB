        ...
        case .online(.wwan), .online(.wiFi):
            self.audioPlayer.play()
             if let images_count = self.postArray[gesture.view!.tag]["photo_album"] as? [[String:Any]]{
                ...
                let cell = self.tableView.cellForRow(at: IndexPath(row:  0, section: gesture.view!.tag + 3)) as! PhotoAlbumCell
                ...
                let cell = self.tableView.cellForRow(at: IndexPath(row: 0, section: gesture.view!.tag + 3)) as! PhotoAlbum2
                ...
                let cell = self.tableView.cellForRow(at: IndexPath(row: 0, section: gesture.view!.tag + 3)) as! PhotoAlbum3
    ...
    func addReaction(reation: String) {
        self.audioPlayer.play()
         if let images_count = self.postArray[self.selectedIndex]["photo_album"] as? [[String:Any]]{
            if  images_count.count == 1{
            let cell = self.tableView.cellForRow(at: IndexPath(row: 0, section: self.selectedIndex + 3)) as! PhotoAlbumCell
            ...
            if reation == "1"{
                ...
                let cell = self.tableView.cellForRow(at: IndexPath(row: 0, section: self.selectedIndex + 3)) as! PhotoAlbum2
            self.reactions(index: self.selectedIndex, reaction: reation)
            var localPostArray = self.postArray[self.selectedIndex]["reaction"] as! [String:Any]
            var totalCount = 0
            if let reactions = self.postArray[self.selectedIndex]["reaction"] as? [String:Any]{
    ...
    func comment_Count() {
            if let images_count = self.postArray[self.selectedIndex]["photo_album"] as? [[String:Any]]{
                if images_count.count == 1{
                    ...
                    let cell = self.tableView.cellForRow(at: IndexPath(row: 0, section: self.selectedIndex + 3)) as! PhotoAlbum3
