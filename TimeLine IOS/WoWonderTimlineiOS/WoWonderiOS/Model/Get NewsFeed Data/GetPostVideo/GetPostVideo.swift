...
class GetPostVideo :AddReactionDelegate,SharePostDelegate,comment_CountsDelegate {
    ...
    @IBAction func NormalTapped(gesture: UIGestureRecognizer){
        ...
        case .online(.wwan), .online(.wiFi):
            let cell = self.tableView.cellForRow(at: IndexPath(row: 0, section: gesture.view!.tag + 3)) as! VideoCell
    ...
    func addReaction(reation: String) {
        let cell = self.tableView.cellForRow(at: IndexPath(row: 0, section: self.selectedIndex + 3)) as! VideoCell
        self.audioPlayer.play()
...
//        }
    ...
    @objc func playVideo (_ sender : UIButton){
        ...
        let cell = tableView.cellForRow(at: IndexPath(row: 0, section: indexPath.row + 3)) as! VideoCell
        cell.videoView.play()
